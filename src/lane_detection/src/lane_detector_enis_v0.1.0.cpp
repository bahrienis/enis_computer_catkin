...
bool bSuccess = cap.read(inputImg);
 ...
 // The 4-points at the input image	
	...
	origPoints.push_back( Point2f(dWidth, dHeight/3) );
	origPoints.push_back( Point2f(0, dHeight/3) );
  	 
	// The 4-points correspondences in the destination image
	vector<Point2f> dstPoints;
	dstPoints.push_back( Point2f(dWidth/2-80, dHeight) );
...
GaussianBlur( inputImg, inputImg, Size(5,5), 0, 0, BORDER_DEFAULT );	//GaussianBlur( src, src, Size(3,3), 0, 0, BORDER_DEFAULT );		 
